...
console, Americas. Runs after wiki.maps and blizzard.meta.
    ...
    python -m data.load.counterpick.heroes
"""
...
from data.extract.counterpick.heroes import CounterpickError, parse_table
from data.transform.counterpick.names import index, match_key
