...
through the same door.
    ...
    python -m data.mcp                 serve over stdio (what .mcp.json launches)
    python -m data.mcp list            print the tools
    python -m data.mcp call pull_maps  run one tool from the shell
