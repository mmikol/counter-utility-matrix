...
<select>
  ...
  <option class="role" data-role="damage" style="background-image:url('damage.svg')">Damage</option>
...
SLIDE = ('<blz-feature slot="slide"><h3 class="heading">%s</h3>'
...
STADIUM = ('<blz-section id="stadium"><div class="perk-category minor">%s</div></blz-section>'
