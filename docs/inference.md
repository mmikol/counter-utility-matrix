...
<!-- generated:catalog -->
5 files in `inference/strategies/`: 0 constraints (0 limits, 0 scored), 0 heuristics and 5 assumptions. Regenerated by `.venv/bin/python -m db.mcp call db_docs`.
