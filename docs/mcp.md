...
tab and the `/record` skill both call `record_match`; the headless
agents may call none of the three.

## The tools

<!-- generated:tools -->
36 tools, in the order the server lists them. Regenerated by `.venv/bin/python -m door.mcp call db_docs`.
